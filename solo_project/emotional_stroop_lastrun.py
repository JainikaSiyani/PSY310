...
expName = 'emotional_stroop'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='E:\\PSY310\\solo_project\\emotional_stroop_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    text_2 = visual.TextStim(win=win, name='text_2',
        text='Thank you for your particpation. Below are the instructions for the task you are going to perform, please read them carefully.\n\nA word will appear on your screen, you need to focus on the colour of the word while ignoring its meaning and respond which coulour are you seeing. Please, respond as quickly but carefully. To record your response you need to press the following keys signifying each colour: \'y\' for yellow, \'r\' for red, \'g\' for green, and \'b\' blue. \n\nTo continue to the experiment please press "space" bar. \n\n',
        font='Arial',
    ...
    for thisTrial in trials:
        ...
        continueRoutine = True
        # update component parameters for each repeat
        thisExp.addData('Trail.started', globalClock.getTime(format='float'))
        ...
        _key_resp_allKeys = []
        # keep track of which components have finished
        TrailComponents = [fixation, text, key_resp]
        ...
        for thisComponent in TrailComponents:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        thisExp.addData('Trail.stopped', globalClock.getTime(format='float'))
        # check responses
