...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='E:\\PSY310\\sequence_learning\\sequence_learning_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    line1 = visual.Rect(
        ...
        width=(120, 20)[0], height=(120, 20)[1],
    ...
    trials = data.TrialHandler(nReps=200.0, method='sequential', 
        ...
        trialList=data.importConditions('C:/Users/Asus/OneDrive/Desktop/sequence_con.csv'),
